...
public class BoardDAO {
	...
	public void delete(int boardNumber) {
		System.out.println("게시글 삭제 메소드 실행!" + boardNumber);
	...
	public void update(BoardDTO boardDTO) {
		System.out.println("게시글 수정 메소드 실행!" + boardDTO);
		sqlSession.delete("board.update", boardDTO);
