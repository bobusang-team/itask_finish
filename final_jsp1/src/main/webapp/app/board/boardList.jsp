						...
						<c:forEach var="board" items="${boardList}">
							<div class="board-row">
								...
								<div class="board-item title">
									<!-- 제목 클릭 시 상세 페이지로 이동 -->
									<a
										href="${pageContext.request.contextPath}/board/boardReadOk.bo?boardNumber=${board.getBoardNumber()}"> <!-- 쿼리스트링형식. 해당번호를 가져올 수 있음 -->
								...
								<div class="board-item date">
									...
									<c:out value="${fn:substring(board.boardDate, 0, 10) }"/> <!-- 날짜를 YYYY-MM-DD로 출력하는 방식 = 10글자만 출력하겠다.-->
								</div>
