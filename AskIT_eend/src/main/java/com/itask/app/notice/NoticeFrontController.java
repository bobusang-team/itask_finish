...
//			request.getRequestDispatcher("/app/notice/notice.jsp").forward(request, response);
//			서블릿 타는지 확인하려고 넣은 코드 = 잘 탔고 경로 확인 완료.
...
//				request.getRequestDispatcher("/app/notice/noticeDetail.jsp").forward(request, response);
//	    	  서블릿타는지 확인하려고 넣은 코드 = 잘 탔고 경로 확인 완료.
