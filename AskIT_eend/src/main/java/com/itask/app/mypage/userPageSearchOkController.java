...
public class userPageSearchOkController implements Execute {
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("클릭한 유저의 닉네임 : " + userNick);
		
		//닉네임으로부터 해당 유저의 정보를 가져오는 쿼리 실행 DTO는 (mypage == userpage)
		mypageMainDTO = mypageDAO.userPageSelect(userNick);
		System.out.println("Controller에서 출력하는 해당 유저의 DTO" + mypageMainDTO); // 확인용
