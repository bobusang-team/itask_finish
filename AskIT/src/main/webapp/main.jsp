		...
		<div class="main-container">
			<div class="main-content-wrapper">
				...
				<section class="bestQ">
					...
					<h3>이달의 Best 질문</h3>
					<a id="bestMoonLink" href="#"> <span id="bestMoonTag">카테고리</span>
						<div>
				...
				document.addEventListener("DOMContentLoaded", function () {
					...
					console.log("contextPath 확인:", contextPath);
