			...
			<main class="askBox">
				...
				<div class="ask-topcontainer">
					...
					<div class="ask-category">
						<button class="category-btn ask-select" onclick="setBotCate('질문')">질문</button>
						<button class="category-btn" onclick="setBotCate('꿀팁')">꿀팁</button>
					</div>
					<!-- 자격증 태그 버튼 -->
					<div class="ask-tag">
						<button class="ask-tag-btn selected" onclick="setTag('Java')">Java</button>
				...
				<div class="ask-text-header">
					...
					<div class="ask-text-profile">
						<img src="./../assets/img/profile.png" alt=""> <span
							class="ask-text-author"><b>${article.formattedMoniter}</b>
				...
				<article class="text-textbottom">
					...
					<div class="Detail-content">
						<img src="./../assets/img/moniter.png" alt="모니터수"
							id="Detail-moniter-img"> <span id="Detail-monitercount">${article.articleMoniter }</span>
				...
				<c:forEach var="comments" items="${comments}">
					...
					<div id="comment-section">
						...
						<div class="askDetail-comment-show">
							<span class="askDetail-comment-author">${comments.formattedMoniter}${comments.userNick}</span>
							...
							<div class="askDetail-comment-info">
								...
								<span class="askDetail-comment-monitor"> <img
									src="./../assets/img/moniter.png" alt="사진오류">
