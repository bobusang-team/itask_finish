		    ...
		    <div class="bjs-ask-topcontainer">
		      ...
		      <span class="bjs-ask-title">개발</span>
		        ...
		        <div class="bjs-ask-category">
		          <button class="bjs-ask-category-btn "><a href="${pageContext.request.contextPath}/dev/listAsk.dev">질문</a></button>
		          <button class="bjs-ask-category-btn bjs-ask-select"><a href="${pageContext.request.contextPath}/dev/listTip.dev">꿀팁</a></button>
		        </div>
		      ...
		      <!--게시물 목록-->
		      <c:forEach var="dev" items="${devListTip}">
				         ...
				         <article class="bjs-ask-post-item" data-tag="${dev.articleTagname}">
				            <div class="bjs-ask-post-header">
				                ...
				                <span class="bjs-ask-post-title">
				                    <a href="${pageContext.request.contextPath}/dev/detailTip.dev?articleNum=${dev.articleNum}">
				                        ${dev.articleTitle}
				                    </a>
				                </span>
				            </div>
				            <div class="bjs-ask-post-body">
				                ${dev.articleText}
				                <a href="${pageContext.request.contextPath}/dev/detailTip.dev?articleNum=${dev.articleNum}"></a>
				            </div>
