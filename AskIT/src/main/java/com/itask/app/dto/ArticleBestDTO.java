...
public class ArticleBestDTO {
//	CREATE TABLE TBL_ARTICLE (
//		    ARTICLE_NUM NUMBER NOT NULL,
//		    USER_NUM NUMBER NOT NULL,
//		    ARTICLE_TOPCATE VARCHAR2(100) CHECK (UPPER(ARTICLE_TOPCATE) IN ('媛쒕컻', '蹂댁븞', '�옄寃⑹쬆')),
//		    ARTICLE_BOTCATE VARCHAR2(100) CHECK (UPPER(ARTICLE_BOTCATE) IN ('吏덈Ц', '轅��똻')),
...
//		);
	...
	public String toString() {
		return "ArticleBestDTO [articleNum=" + articleNum + ", userNum=" + userNum + ", articleTopCate="
				...
				+ articleMonitorNum + ", userNick=" + userNick + "]";
	}
