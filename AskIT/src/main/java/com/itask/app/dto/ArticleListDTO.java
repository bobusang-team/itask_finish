...
public String toString() {
	return "ArticleListDTO [articleNum=" + articleNum + ", userNum=" + userNum + ", articleTopcate=" + articleTopcate
			...
			+ articleView + ", articleMonitorNum=" + articleMonitorNum + ", userMonitor=" + userMonitor
			+ ", userMentoCert=" + userMentoCert + ", userNick=" + userNick + ", badge=" + badge + ", category="
			+ category + "]";
}
...
//		);
	...
	public String toString() {
		return "ArticleListDTO [articleNum=" + articleNum + ", userNum=" + userNum + ", articleTopcate="
				...
				+ ", userCert=" + userCert + ", userNick=" + userNick + ", grade=" + grade + ", badge=" + badge + "]";
	}
